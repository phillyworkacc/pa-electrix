         ...
         <div className="page-container">
            {(deviceType == "desktop") && (<>
               <div className="box full dfb align-center">
                  ...
                  <div className="box full dfb align-center justify-center gap-20" style={{ color: websiteConfig.headerTextColor }}>
                  ...
                  <div className="box fit dfb align-center justify-end gap-10">
                     <Link href={`tel:${websiteConfig.phoneNumber.replaceAll(' ','')}`}>
                        <button className="xs pd-15 pdx-15 whitespace-nowrap">
                           <Phone size={18} /> {websiteConfig.phoneNumber}
                        </button>
                     </Link>
                     <Link href={"/get-free-quote"}>
                        <button className="xs outline-accent-color pd-15 pdx-15 whitespace-nowrap">
                           GET FREE QUOTE
                        </button>
                     </Link>
                  </div>
